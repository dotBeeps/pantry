/**
 * Integration test for berrygems/extensions/dragon-loop.ts
 *
 * SC-minimum bar per D-04:
 *   1. Extension loads without error via createTestSession.
 *   2. Registers 1 command: "loop". Registers 1 tool: "signal_loop_success".
...
const EXT_PATH = path.resolve(THIS_DIR, "../../extensions/dragon-loop.ts");

const EXPECTED_COMMANDS = ["loop"];
const EXPECTED_TOOLS = ["signal_loop_success"];

describe("extension: dragon-loop", () => {
