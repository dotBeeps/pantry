/**
 * Integration test for berrygems/extensions/kobold-housekeeping.ts
 *
 * SC-minimum bar per D-04:
 *   1. Extension loads without error via createTestSession.
 *   2. Registers 1 command: "todos". Registers 1 tool: "todo_panel".
...
const EXT_PATH = path.resolve(
  THIS_DIR,
  "../../extensions/kobold-housekeeping.ts",
);

const EXPECTED_COMMANDS = ["todos"];
const EXPECTED_TOOLS = ["todo_panel"];

describe("extension: kobold-housekeeping", () => {
