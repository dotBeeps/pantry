/**
 * Integration test for berrygems/extensions/dragon-curfew.ts
 *
 * SC-minimum bar per D-04:
 *   1. Extension loads without error via createTestSession.
 *   2. Registers 1 command: "curfew". Registers 0 tools.
...
const EXT_PATH = path.resolve(THIS_DIR, "../../extensions/dragon-curfew.ts");

const EXPECTED_COMMANDS = ["curfew"];

describe("extension: dragon-curfew", () => {
