/**
 * Integration test for berrygems/extensions/dragon-inquiry.ts
 *
 * SC-minimum bar per D-04:
 *   1. Extension loads without error via createTestSession.
 *   2. Registers 0 commands. Registers 1 tool: "ask".
...
const EXT_PATH = path.resolve(THIS_DIR, "../../extensions/dragon-inquiry.ts");

const EXPECTED_TOOLS = ["ask"];

describe("extension: dragon-inquiry", () => {
