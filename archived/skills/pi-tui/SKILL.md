...
For the full API source, read pi's [tui.md](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/tui.md). For copy-paste patterns, see the `extension-designer` skill's `references/tui-patterns.md`.
